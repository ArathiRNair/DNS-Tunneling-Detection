"""
DNS Tunneling Detection - Test HistGradientBoosting Training
------------------------------------------------------------
Verifies that the HistGradientBoosting model can be trained successfully
...
from src.train_models import train_hist_gradient_boosting

def test_hgb_training():
    print("=" * 70)
    print("  TEST: HIST-GRADIENT BOOSTING TRAINING")
    print("=" * 70)
    ...
    try:
        ...
        # 4. Train Model
        print("4. Training HistGradientBoostingClassifier...")
        model = train_hist_gradient_boosting(X_train, y_train, random_state=42)
        ...
        print("\n======================================================================")
        print("  [SUCCESS] HistGradientBoosting training pipeline test PASSED!")
        print("======================================================================")
        return True
